...
import { CalendarDays, MapPin, Clock, ShieldAlert } from "lucide-react";
    ...
    const scheduleItems = [
        {
            ...
            note: "Focus on transitional triggers",
        },
        {
            type: "match",
            ...
            note: "Arrive 90 mins early for warm-ups",
            isNext: true,
        },
        {
            type: "training",
        ...
        <main className="flex flex-col h-full w-full animate-float pb-24" style={{ animationDuration: '15s' }}>
            ...
            <div className="pt-4 pb-6 px-1 flex justify-between items-end">
                <div>
                    ...
                    <p className="text-white/60 text-sm">Your upcoming events and agenda.</p>
                </div>
                <div className="w-10 h-10 rounded-full bg-purple-500/20 backdrop-blur-md border border-purple-500/30 flex items-center justify-center text-purple-400 shadow-[0_0_15px_rgba(168,85,247,0.4)] cursor-pointer hover:bg-purple-500/30 transition-colors">
            ...
            <div className="flex gap-3 overflow-x-auto pb-4 mb-4 hide-scrollbar px-1">
                {["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"].map((day, i) => (
                    ...
                    >
                        ...
                        <span className={cn("text-xl font-bold", i === 0 && "text-purple-400")}>{12 + i}</span>
                    </div>
                ))}
            </div>
            ...
            <div className="flex flex-col gap-4 relative">
                ...
                <div className="absolute left-[20px] top-4 bottom-0 w-0.5 bg-gradient-to-b from-purple-500 via-white/10 to-transparent z-0" />
                ...
                {scheduleItems.map((item, idx) => (
                    <div key={idx} className="relative z-10 pl-12 pr-1">
                        ...
                        <div className={cn(
                            ...
                            item.type === "match" ? "bg-accent-blue shadow-[0_0_12px_rgba(0,225,255,0.8)]" : "bg-purple-500 shadow-[0_0_12px_rgba(168,85,247,0.8)]"
                        )} />

                        <LiquidCard className={cn(
                            "p-4 relative overflow-hidden group border",
                            item.isNext ? "border-purple-500/40 shadow-[0_0_20px_rgba(168,85,247,0.1)]" : "border-white/10"
                        )}>
                            {item.isNext && (
                                <div className="absolute top-0 right-0 bg-purple-500 text-white text-[10px] font-bold uppercase tracking-wider px-3 py-1 rounded-bl-xl shadow-[0_0_10px_rgba(168,85,247,0.5)] z-10">
                                    Up Next
                                </div>
                            )}
                            ...
                            <div className={cn(
                                ...
                                item.type === "match" ? "bg-accent-blue/10 opacity-0" : "bg-purple-500/10 opacity-0"
                            )} />
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <div className="flex items-center gap-2 text-white/70 text-sm mt-1 pt-2 border-t border-white/10">
                                    ...
                                    <span className="font-medium text-white/60">{item.note}</span>
                                </div>
                            </div>
                        </LiquidCard>
                    </div>
